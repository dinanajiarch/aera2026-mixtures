...
lca_enum_fit <- mplusModeler(lca_enum, glue(here("enumeration","lsay.dat")),
                            modelout= glue(here("enumeration","c{k}_lsay.inp")),
...
output_enum <- readModels(here("enumeration"), quiet = TRUE)
...
item_labels <- c("CB28A" = "I enjoy math",
                 ...
                 "CB28E" = "Doing math often makes me nervous or upset",
                 "CB28G" = "I often get scared when I open my math book and see a page of problems",
                 "CB28H" = "Math is useful in everyday problems",
                 "CB28I" = "Math helps a person think logically",
                 "CB28K" = "It is important to know math to get a good job",
